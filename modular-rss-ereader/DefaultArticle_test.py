...
class TestDefaultArticle(unittest.TestCase):
    ...
    def test_time_to_read_in_minutes(self):
        ...
        # 0 wpm
        self.assertEqual(a._time_to_read_in_minutes(), 0)
        ...
        # 1600 word_count
        a.word_count = 1600
        self.assertEqual(a._time_to_read_in_minutes(), 8)

        # 350 word_count
        a.word_count = 350
        self.assertEqual(a._time_to_read_in_minutes(), 1)
    ...
    def test_time_to_read_str(self):
        ...
        a.word_count = 14500
        self.assertEqual(a._time_to_read_str(),'1 hr 12 min')
        # converts hours without remainder correctly
        a.word_count = 12000
        self.assertEqual(a._time_to_read_str(),'1 hr 0 min')
        # converts minutes correctly
        a.word_count = 1600
        self.assertEqual(a._time_to_read_str(),'8 min')
        # converts days correctly
        a.word_count = 289000
        self.assertEqual(a._time_to_read_str(),'24 hr 5 min')
